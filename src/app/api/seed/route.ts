...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ 
      ...
      users: [
        { email: 'admin@georgies.com', password: 'admin123', role: 'ADMIN' },
        { email: 'manager@georgies.com', password: 'manager123', role: 'MANAGER' },
        { email: 'staff@georgies.com', password: 'staff123', role: 'STAFF' },
      ]
    })
